                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="test">{{ __('voyager::generic.test') }}</label>
                                <input type="text" class="form-control" id="test" name="test" placeholder="{{ __('voyager::generic.test') }}"
                                       value="@if(isset($dataTypeContent->test)){{ $dataTypeContent->test }}@endif">
                            </div>
